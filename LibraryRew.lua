local Profiler = loadstring([[return LPH_NO_VIRTUALIZE(function()
	-- Profile code time.
...
local CoreGuiManager = loadstring([[---@note: We need to be careful where we use CoreGui because exploits have this weird permission issue. We need consistent setting of the parent.
